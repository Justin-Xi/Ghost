    ...
    for input_filename, need_add, mult_round in input_filelist:
        ...
        while idx < len(input_lines):
            ...
            for row_idx in range(0, row_num, 2):
                ...
                # input_text = "先帮我新建一个每周六下午9点到10点打羽毛球的循环日程，地点在东方大厦四楼，再把之前有人给我发过路线帮我找一下然后放到付件里，到时候提前30分钟提醒我" #444444444444444
                input_text = "先帮我新建一个打羽毛球的待办，再把之前有人给我发过路线帮我找一下然后放到备注里." #444444444444444
                if input_text == "":
                    assert row_idx != 0
                    continue
